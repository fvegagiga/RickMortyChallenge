...
- Make it **descriptive** (per Git Workflow in `docs/domain-data-standards.md` and `docs/presentation-standards.md`).
...
- `docs/domain-data-standards.md` and `docs/presentation-standards.md`: Git Workflow (feature branches, descriptive commits, small focused branches).
