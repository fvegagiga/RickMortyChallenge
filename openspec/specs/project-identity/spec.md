...
Defines the canonical project name, test target naming, bundle identifiers, App Group identifiers, and build/test expectations for the Rick and Morty Challenge iOS workspace.
