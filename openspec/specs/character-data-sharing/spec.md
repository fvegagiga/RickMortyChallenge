# Capability: Character Data Sharing

## Purpose

Defines how the main app shares character data with the WidgetKit extension via a shared App Group. This covers the `AppGroupStore` abstraction, the snapshot write strategy (randomized subset on load/refresh), and the image caching mechanism using the shared FileManager container.
